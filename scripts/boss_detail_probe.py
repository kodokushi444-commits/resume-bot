...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Probe a few BOSS detail pages from the current results page.")
...
def main() -> int:
    ...
    source = BossBrowserSource(
        name="boss_browser_detail_probe",
        ...
        max_detail_pages=max(1, min(int(args.limit or 1), 5)),
    ...
    try:
        payload = source.probe_detail_pages(
            city=args.city,
