...
class LocalWebTests(unittest.TestCase):
    def test_local_web_assets_promote_boss_workbench_and_keep_legacy_panel(self) -> None:
        ...
        self.assertNotIn("柔和甜风", INDEX_HTML)
        self.assertNotIn("#db888b", INDEX_HTML)
        self.assertIn("森林暖金", INDEX_HTML)
        self.assertIn("云莓晴空", INDEX_HTML)
        self.assertIn("橙海晴蓝", INDEX_HTML)
        self.assertIn("#556136", INDEX_HTML)
        self.assertIn("#242f1a", INDEX_HTML)
        self.assertIn("#fca7c4", INDEX_HTML)
        self.assertIn("#053f5c", INDEX_HTML)
        self.assertIn("#f27f0c", INDEX_HTML)
